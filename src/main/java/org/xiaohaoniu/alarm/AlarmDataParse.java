package org.xiaohaoniu.alarm;

import org.xiaohaoniu.CommonMethod.CommonUtil;
import org.xiaohaoniu.NetSDKDemo.HCNetSDK;
import com.sun.jna.Pointer;
import org.xiaohaoniu.Util.WeChatMpOkHttpUtils;
...
//                String accessToken = WeChatMpOkHttpUtils.getInstance().getAccessToken();
//                String openId = "";
//                String templateId = "R8QGpwsXE-kO1XQVOG7Y3MEK7V9rlzSueTT70uacnJI";
//                Map<String, Object> data = new HashMap<>();
//                data.put("thing19.DATA", "原因");
//                data.put("thing21.DATA", "未知");
//                data.put("time2.DATA", "2024-1-1");
//
//                boolean result = WeChatMpOkHttpUtils.getInstance().sendTemplateMessage(accessToken, openId, templateId, data);
